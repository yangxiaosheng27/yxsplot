        ...
        if _check_language_Chinese() == True:
            help_info = "\n".join(
                (
                    ...
                    "• 上一个视图： 键盘 ← ",
                    "• 下一个视图： 键盘 → ",
                    r"• 重载无压缩视图： 左键点击$\boldsymbol{\circlearrowright}$",
                )
            )
        else:
            help_info = "\n".join(
                (
                    ...
                    "• Zoom to selection: L-drag",
                    "• Reset view: R-click",
                    "• Pan view: R-drag",
                    "• Zoom in/out: Wheel scroll",
                    "• Auto-scale Y-axis: Long R-press",
                    "• Show data tag: L-click a point",
                    "• Hide data tag: R-click the tag",
                    "• Show/hide trace: L-click legend",
                    "• Add ruler: Wheel drag",
                    "• Clear ruler: Wheel click",
                    "• Previous view: keyboard ←",
                    "• Next view: keyboard →",
                    r"• Reload uncompressed view: L-click the $\boldsymbol{\circlearrowright}$",
                )
            )
